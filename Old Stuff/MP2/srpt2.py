...
class PCB:
    ...
    def __str__(self):
        ...
        # return f"Process {self.pID} | Waiting Time: {self.arrival} | Burst Time: {self.burst_time}"
    ...
    def run(self):
        ...
        while self.current_time <= (self.processes[-1].arrival):
            ...
            if executing_process == None or ready_process.burst_time <= executing_process.burst_time:
                ...
                self.sequence.append((executing_process.pID, 1))
                
                if executing_process.burst_time > 0:
                    self.queued_processes.append(executing_process)
                elif executing_process.burst_time == 0:
        ...
        while self.queued_processes:
            ...
            executing_process.turnaround_time = executing_process.waiting_time + original_burst_times[executing_process.pID]
